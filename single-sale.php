...
<?php while (have_posts()) : the_post(); ?>
    <article <?php post_class(); ?>>
                        ...
                        <?php
                            ...
                            <div class="svg-container">
                                <object type="image/svg+xml"
                                        data="<?php bloginfo('template_directory'); ?>/assets/img/begip-agence-immobiliere.svg"
        ...
        <section class="row">
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a href="#description" data-toggle="tab"><?php _e('Summary ', 'roots-immo'); ?></a>
                </li>
