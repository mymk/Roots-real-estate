...
function optionsframework_options()
{
    ...
    $options[] = [
        'name' => __('Roots immo settings', 'options_framework_theme'),
        'type' => 'heading', ];
/*
    $options[] = array(
    ...
    $options[] = [
        ...
        'desc' => __('A text input field.', 'options_framework_theme'),
        'id'   => 'linkedin_url',
        'std'  => 'https://www.linkedin.com/profile/view?id=',
        'type' => 'text', ];

    $options[] = [
        'name' => __('Google analytics', 'options_framework_theme'),
        'desc' => __('rentrez ici les codes google analytics.', 'options_framework_theme'),
        'id'   => 'google_analytics',
        'std'  => '',
        'type' => 'editor', ];
