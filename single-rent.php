            ...
            <div class="col-md-8">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#photos" data-toggle="tab"><i
                                class="icon-camera"></i><?php _e('Photos', 'roots-immo'); ?></a></li>
                    <?php if (has_Video()) { ?>
                        <li><a href="#video" data-toggle="tab"><i
                                    class="icon-video"></i><?php _e('Video', 'roots-immo'); ?></a></li>
                    <?php } ?>
                    <?php if (has_Map()) { ?>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="photos">
                        ...
                        <?php
                            ...
                            ?>
                            <img src="<?php bloginfo('template_directory'); ?>/assets/img/logo.jpg"
                    ...
                    <?php if (has_Video()): ?>
                        <div class="tab-pane" id="video">
                            <div class="fluid-width-video-wrapper" style="padding-top: 56.2%;">
                                <iframe src="http://player.vimeo.com/video/12158329" frameborder="0"
                                        webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""
                                        id="fitvid317791"></iframe>
                            </div>
                        </div>
                    <?php endif; ?>
                        ...
                        <div class="tab-pane" id="map">
                            ...
                            if (!empty($mapAdresse)) :
                                ...
                                <iframe width="100%" height="300" frameborder="0" scrolling="no" marginheight="0"
                                        marginwidth="0"
                                        src="//maps.google.com/maps?f=q&amp;source=s_q&amp;hl=es-419&amp;geocode=&amp;q=<?php echo $mapAdresse; ?>&amp;aq=3&amp;sll=<?php echo $mapPoint; ?>&amp;ie=UTF8&amp;t=m&amp;ll=<?php echo $mapPoint; ?>amp;z=13&amp;output=embed"></iframe>
            ...
            <div class="col-md-12 add-top">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#description"
                                          data-toggle="tab"><?php _e('Summary ', 'roots-immo'); ?></a></li>
                    <li><a href="#dossierlocataire"
                           data-toggle="tab"><?php _e('Dossier locataire ', 'roots-immo'); ?></a></li>
                    <li><a href="#send-to-friend" data-toggle="tab"><?php _e('Send to a friend', 'roots-immo'); ?></a>
                    </li>
                </ul>
                        ...
                        <div class="col-md-12">
                            ...
                            <section>
                                ...
                                <ul>
                                    ...
                                    <li>Attestation d’assurance » Risques locatifs » : Obligatoire pour la remise des
                                        clés, au nom du preneur, avec l’adresse précise de l’appartement et prenant
                                        effet le jour de la remise des clés.
                                    </li>
                            ...
                            <section>
                                ...
                                <ul>
                                    ...
                                    <li>Copie du dernier avertissement fiscal</li>
                                    <li>Imprimé de cautionnement, à compléter impérativement par le cautionnaire,
                                        document fourni à l’agence
                                    </li>
                                    <li>Relevé d’identité bancaire</li>
                                </ul>
                            </section>
