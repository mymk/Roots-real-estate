...
Cordialement</textarea>
        ...
        <div class="form-group col-md-6">
            ...
            <input id="your-name" name="name" class="form-control" placeholder="<?php _e('Your Name', 'roots-immo'); ?>"
                   type="text" required="">
        </div>

        <div class="form-group col-md-6">
            <label for="your-email" class="screen-reader-text"><?php _e('E-mail', 'roots-immo'); ?></label>
            <input id="your-email" name="email" class="form-control" placeholder="<?php _e('E-mail', 'roots-immo'); ?>"
                   type="email" required="">
        </div>

        <div class="form-group col-md-6">
            <label for="your-telephone" class="screen-reader-text"><?php _e('Your telephone', 'roots-immo'); ?></label>
            <input id="your-telephone" name="telephone" class="form-control"
                   placeholder="<?php _e('Your telephone', 'roots-immo'); ?>" type="text" required="">
        </div>

        <div class="form-group col-md-6">
            <label for="showing-date" class="screen-reader-text"><?php _e('Showing date', 'roots-immo'); ?></label>
            <input id="showing-date" name="date" class="date form-control"
                   placeholder="<?php _e('Showing date', 'roots-immo'); ?>" type="text" required="">
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            <button type="submit"
                    class="btn btn-default send-message"><?php _e('Request showing', 'roots-immo'); ?></button>
        </div>
