	...
	<section class="row">
		<div class="col-md-8">
			<h3 class="side-tagline"><?php _e('STAY IN CONTACT THROUGH OUR SOCIAL NETWORKS FOR UPDATES', 'roots-immo'); ?></h3>
		</div>

		<ul class="social-aside col-md-4 remove-bottom nav nav-pills">
