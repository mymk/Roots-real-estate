...
class Options_Framework_Media_Uploader
{
    ...
    {
        add_action('admin_enqueue_scripts', [$this, 'optionsframework_media_scripts']);
    }
    ...
    public function optionsframework_media_scripts($hook)
    {
        ...
        wp_register_script('of-media-uploader', OPTIONS_FRAMEWORK_DIRECTORY.'js/media-uploader.js', ['jquery'], Options_Framework::VERSION);
