...
class Options_Framework_Admin
{
    ...
    public function init()
    {
        ...
        if ($options) {
            ...
            add_action('admin_menu', [$this, 'add_custom_options_page']);
            ...
            add_action('wp_before_admin_bar_render', [$this, 'optionsframework_admin_bar']);
        }
    }
    ...
    public function settings_init()
    {
        ...
        register_setting('optionsframework', $optionsframework_settings['id'],  [$this, 'validate_options']);

        // Displays notice after options save
        add_action('optionsframework_after_validate', [$this, 'save_options_notice']);
    }
    ...
    public function enqueue_admin_styles($hook)
    {
        ...
        wp_enqueue_style('optionsframework', OPTIONS_FRAMEWORK_DIRECTORY.'css/optionsframework.css', [], Options_Framework::VERSION);
    ...
    public function enqueue_admin_scripts($hook)
    {
        ...
        wp_enqueue_script('options-custom', OPTIONS_FRAMEWORK_DIRECTORY.'js/options-custom.js', ['jquery', 'wp-color-picker'], Options_Framework::VERSION);

        // Inline scripts from options-interface.php
        add_action('admin_head', [$this, 'of_admin_head']);
    }
    ...
    public function of_admin_head()
    {
     ...
     public function options_page()
     {
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
         ...
         ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e('Restore Defaults', 'textdomain');
         ?>" onclick="return confirm( '<?php echo esc_js(__('Click OK to reset. Any theme settings will be lost!', 'textdomain'));
         ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
